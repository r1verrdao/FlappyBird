...
bird_downflap = pygame.transform.scale2x(pygame.image.load("assets/boeing.png").convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load("assets/boeing.png").convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load("assets/boeing.png").convert_alpha())
...
pipe_surface = pygame.transform.scale((pipe_surface), (86, 550))
pipe_list =[]
